...
public class ItemController {
    ...
    @PostMapping
    public ResponseEntity<Object> itemCreateRequestDTO
            (
    ...
    @PatchMapping("/{itemId}")
    public ResponseEntity<Object> itemUpdateDTO
            (
    ...
    @GetMapping("/{itemId}")
    public ResponseEntity<Object> itemGetDTO
            (
                    @PathVariable Long itemId,
                    @RequestHeader("X-Sharer-User-Id") Long userId
            ) {
    ...
    @GetMapping
    public ResponseEntity<Object> itemsGetAllDTO
            (
                    @RequestHeader("X-Sharer-User-Id") Long userId,
    ...
    @GetMapping("/search")
    public ResponseEntity<Object> itemsGetAllSearchDTO
            (
    ...
    public ResponseEntity<Object> addCommentsDTO
            (
                    @RequestHeader("X-Sharer-User-Id") Long userId,
                    @PathVariable Long itemId,
